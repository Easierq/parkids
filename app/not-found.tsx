        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <div className="mb-8 relative">
              <h1
                className="text-[180px] md:text-[250px] font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-emerald-500 to-blue-500 leading-none select-none"
                style={{
